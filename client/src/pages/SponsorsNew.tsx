...
import SponsorsFolderGroup from "@/components/SponsorsFolderGroup";

export default function SponsorsNew() {
  ...
  const renderSelectedTierContent = () => {
    const tier = selectedTier as keyof typeof tierConfig;
    const config = tierConfig[tier];
    const tieredSponsors = sponsorsByTier[selectedTier as string] || [];
    ...
    return (
      <div className="animate-fade-in">
        ...
        <div className="text-center mb-12">
          <div
            className={`inline-block px-6 py-2 rounded-full ${config.color} mb-4`}
          >
            <Badge
              variant="outline"
            ...
            >
              <CardContent className="p-8 text-center">
                ...
                <div className="h-20 bg-muted rounded-lg flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-colors">
                  <span
                    className={`font-bold ${config.textColor} group-hover:text-accent transition-colors`}
                  >
                    {sponsor.name}
                  </span>
                </div>
                ...
                {sponsor.website && (
                  <Button
                    ...
                    data-testid={`sponsor-website-${sponsor.name
                      .toLowerCase()
                      .replace(/\s+/g, "-")}`}
                  >
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Meet the industry leaders and organizations who believe in our
            mission to awaken the next generation of innovators and creators.
          </p>
        </div>
        ...
        {!selectedTier ? (
          <>
            ...
            <div className="flex justify-center items-center my-20">
              <SponsorsFolderGroup onCategorySelect={handleCategorySelect} />
            </div>
                ...
                <CardContent className="p-12 text-center relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                      Join us in shaping the future of innovation. Partner with
                      Crescendo Festival to reach thousands of talented
          ...
          // Display selected tier content
          renderSelectedTierContent()
        )}
      </div>
    </div>
  );
