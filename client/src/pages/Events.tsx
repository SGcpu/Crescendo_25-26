...
export default function Events() {
  ...
  const difficulties = Array.from(new Set(events?.map(event => event.difficulty) || []));
  ...
  const getDifficultyColor = (difficulty: string) => {
    ...
    return colorMap[difficulty] || 'bg-gray-500/20 text-gray-400';
  };
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Discover hackathons, workshops, and competitions that will challenge your limits and expand your horizons
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="font-cinzel text-2xl font-bold mb-4 text-foreground">No Events Found</h3>
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        <i className={`${getCategoryIcon(event.category)} text-primary`} />
