  ...
  const quickEntryCards = [
    {
      ...
      title: 'Events',
      description: 'Discover hackathons, workshops, and competitions that will challenge your limits',
      href: '/events',
      color: 'primary'
    },
    {
      ...
      title: 'Sponsors',
      description: 'Meet our visionary partners making innovation accessible to all',
      href: '/sponsors',
      color: 'accent'
    },
    {
      ...
      title: 'Brochure',
      description: 'Download our complete festival guide with schedules and venue maps',
      href: '/brochure',
      color: 'secondary'
    }
  ];
              ...
              <Link key={index} href={card.href}>
                <Card className="bg-card rounded-2xl border border-border hover-lift cursor-pointer group h-full">
                  <CardContent className="p-8 text-center">
                    <div className={`w-16 h-16 bg-${card.color}/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-${card.color}/30 transition-colors`}>
                      <i className={`${card.icon} text-2xl text-${card.color === 'accent' ? 'accent' : 'primary'}`} />
                    </div>
                    ...
                    <span className="text-accent font-medium hover:underline">
                      Explore {card.title} <i className="fas fa-arrow-right ml-2" />
                    </span>
                  </CardContent>
                </Card>
              </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Three days of pure innovation, featuring cutting-edge competitions, enlightening workshops, and transformative experiences
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((highlight, index) => (
              <div key={index} className="text-center group">
                <div className={`w-20 h-20 bg-${highlight.color}/20 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}>
                  <i className={`${highlight.icon} text-3xl text-${highlight.color === 'accent' ? 'accent' : 'primary'}`} />
                </div>
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <span className="text-muted-foreground text-sm">Day 3 Finale</span>
                  </div>
                  <h3 className="font-cinzel text-4xl font-bold mb-6 text-card-foreground">
                    The Third Eye Challenge
                  </h3>
                  <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                    The ultimate test of innovation awaits. Teams will have 12 hours to solve a mystery challenge 
                    that combines AI, blockchain, and IoT. Only those who see beyond the obvious will claim victory.
                  </p>
                  <div className="flex items-center space-x-6 mb-8">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Teams Max</div>
                    </div>
                    <div className="text-center">
                ...
                <div className="relative">
                  <div className="aspect-video bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl flex items-center justify-center border border-border">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground mt-4">Challenge Visualization</p>
                    </div>
                  </div>
