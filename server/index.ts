...
(async () => {
  ...
  // Set up Vite only in development after routes are registered
  ...
  // If no PORT is set, default to 5000
  const port = parseInt(process.env.PORT || '3000', 10);  // Default to 3000 if no PORT is provided
